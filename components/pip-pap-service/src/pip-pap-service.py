...
class Bundles:
    ...
    def get_bundle_path(self):
        ...
        return os.path.join(self.bundle_storage_path, self.application, self.version, self.bundle_type, "bundle.tar.gz")
...
def get_bundle(application, version, bundleType):
    ...
    bundle = Bundles(app.config['bundle_storage_path'], application, version, bundleType)
    ...
    return send_file(bundle_path, as_attachment=True, mimetype='application/gzip', etag=etag)
